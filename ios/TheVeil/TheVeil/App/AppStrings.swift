...
enum AppStrings {
    ...
    static let scannerIntegrityLabel = "SCANNER INTEGRITY"
    static let resonanceBoltIncomingStatus = "RESONANCE BOLT INCOMING"
    static let resonanceBoltDodgedStatus = "BOLT EVADED"
    static let resonanceImpactStatus = "SCANNER INTEGRITY DAMAGED"
    static let scannerIntegrityCriticalStatus = "SCANNER INTEGRITY CRITICAL"
